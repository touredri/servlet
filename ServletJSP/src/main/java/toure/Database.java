...
//		connexion avec la base de données
        ...
        try {
            this.connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/servlet", "root", "");
...
//			A la fin de la requette on vas ferme la connection
   ...
   /* public boolean existe(String pseudo,String password) {
        ...
        this.InitialiseConnection();
        try {
            PreparedStatement requette = this.connection.prepareStatement("SELECT * FROM users WHERE pseudo = ? and pass = ?;");
